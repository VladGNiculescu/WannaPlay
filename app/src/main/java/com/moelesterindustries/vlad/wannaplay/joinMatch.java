...
public class joinMatch extends AsyncTask<String,Void,String> {
...
System.out.println("SE TRIMITE");
                String link="http://www.vladniculescu.com/databases/android/wannaplay/joinevent.php";
                String
